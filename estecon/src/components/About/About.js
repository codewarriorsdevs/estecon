...
export const About = () => {
    return(
        <>
            ...
            <div className=
            "flex space-x-96 my-7 max-md:block max-md:space-x-0"
            >
                <img src={about} alt="Foto de 1975 " className=
                "w-2/6 max-md:w-3/5 max-md:m-auto"
                />

                <div className=
                "w-2/5 leading-7 text-justify text-2xl max-md:pt-5 max-md:w-auto max-md:text-base"
                >
                    <p>
